      ...
      <main className="container mx-auto px-6 py-12">
        ...
        <div className="flex flex-col md:flex-row items-start mb-12">
          ...
          <div className="md:w-2/3 md:pl-12">
            ...
            <p className="mb-4">
              I'm a passionate web developer and certified Webflow expert with
              over a decade of experience crafting digital experiences that make
              a difference.
            </p>
            <h2 className="text-2xl font-semibold mb-4">My Journey</h2>
            <p className="mb-4">
              My path to web development wasn't a straight line – and that's
              what makes it interesting. I've worn many hats throughout my
              career, from serving in the U.S. Marine Corps and Army National
              Guard to working in law enforcement. These experiences taught me
              the value of discipline, attention to detail, and the importance
              of clear communication – skills that I bring to every web project
              I tackle.
              <br />
              <br />
              In 2017, I took a leap and founded FarsideDev, my own web
              development agency. Here, I've had the privilege of working with a
              diverse range of clients, helping them bring their digital visions
              to life.
            </p>
            ...
            <p className="mb-4">
              But it's not just about the tech. I believe in creating websites
              that not only look great but also deliver results. Whether it's
              increasing conversions, improving user engagement, or simplifying
              complex processes, I'm always focused on the end goal.
            </p>
            ...
            <p className="mb-4">
              I'm always excited to take on new projects and challenges. Whether
              you need a new website, want to optimize your existing digital
              presence, or just want to chat about the latest in web tech, I'd
              love to hear from you.
              <br />
              <br />
              Ready to bring your digital ideas to life? Let's create something
              amazing together!
            </p>
          </div>
        </div>
